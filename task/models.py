...
class Task(models.Model):
    ...
    subtask_text_1 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_2 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_3 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_4 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_5 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_6 = models.CharField(max_length=200, blank=True, null=True)
    subtask_text_7 = models.CharField(max_length=200, blank=True, null=True)
